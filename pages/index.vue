<template>
	<div>
		<!-- HERO -->
		<Hero
			title="UniCredit Learning - Simplu. Clar. Pentru toți."
			bg-img="/bg/HomeBg.png"
			alt-img="Home Page Background"
			paragraph="La UniCredit, credem că încrederea în deciziile financiare
					începe cu înțelegerea lor. De aceea, am creat un spațiu
					digital dedicat tuturor celor care vor să își gestioneze
